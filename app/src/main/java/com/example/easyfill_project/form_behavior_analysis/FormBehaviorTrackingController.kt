...
// For now, it is used only for testing and logging.
    private fun updateOverallFormBehaviorResult() {
        ...
        val formBehaviorDistressScore = when {
            lastOverallFormBehaviorResult.score >= 75 -> 4
            lastOverallFormBehaviorResult.score >= 50 -> 3
            lastOverallFormBehaviorResult.score >= 30 -> 2
            lastOverallFormBehaviorResult.score > 0 -> 1
            else -> 0
        }

        DistressScoringManager.updateFormBehaviorScore(formBehaviorDistressScore)
        ...
        Form behavior distress score = $formBehaviorDistressScore
